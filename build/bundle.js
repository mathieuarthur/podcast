...
var app = (function () {
    ...
    /* src\components\ModalContent.svelte generated by Svelte v3.38.2 */

    const file$3 = "src\\components\\ModalContent.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (audio_1.src !== (audio_1_src_value = /*clip*/ ctx[1])) attr_dev(audio_1, "src", audio_1_src_value);
    			audio_1.controls = true;
    			audio_1.autoplay = true;
    			add_location(audio_1, file$3, 25, 8, 539);
    			add_location(div0, file$3, 26, 8, 604);
    			attr_dev(div1, "class", "clip svelte-pm222y");
    			add_location(div1, file$3, 23, 4, 456);
    			attr_dev(body, "class", "svelte-pm222y");
    			add_location(body, file$3, 22, 0, 444);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*clip*/ 2 && audio_1.src !== (audio_1_src_value = /*clip*/ ctx[1])) {
    				attr_dev(audio_1, "src", audio_1_src_value);
    			}

    			if (dirty & /*texte*/ 1) set_data_dev(t1, /*texte*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["texte", "clip"];
    	...
    	$$self.$$set = $$props => {
    		if ("texte" in $$props) $$invalidate(0, texte = $$props.texte);
    		if ("clip" in $$props) $$invalidate(1, clip = $$props.clip);
    	};

    	$$self.$capture_state = () => ({ texte, clip, audio });
    ...
    class ModalContent extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { texte: 0, clip: 1 });
    		...
    		if (/*texte*/ ctx[0] === undefined && !("texte" in props)) {
    			console.warn("<ModalContent> was created without expected prop 'texte'");
    		}

    		if (/*clip*/ ctx[1] === undefined && !("clip" in props)) {
    			console.warn("<ModalContent> was created without expected prop 'clip'");
    		}
    	}
    ...
    /* src\components\Podcast.svelte generated by Svelte v3.38.2 */
    const file$2 = "src\\components\\Podcast.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			b = element("b");
    			t = text(/*title*/ ctx[0]);
    			add_location(b, file$2, 36, 8, 990);
    			set_style(div, "font-family", /*typo*/ ctx[2]);
    			set_style(div, "color", /*typoColor*/ ctx[3]);
    			set_style(div, "font-size", /*typoSize*/ ctx[4]);
    			add_location(div, file$2, 35, 4, 904);
    			set_style(section, "background-color", /*color*/ ctx[1]);
    			attr_dev(section, "class", "svelte-l38am1");
    			add_location(section, file$2, 34, 0, 834);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(section, "click", /*showModal*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*typoColor*/ 8) {
    				set_style(div, "color", /*typoColor*/ ctx[3]);
    			}

    			if (dirty & /*typoSize*/ 16) {
    				set_style(div, "font-size", /*typoSize*/ ctx[4]);
    			}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const showModal = () => {
    		open(ModalContent, { texte: title, clip });
    	};

    	const writable_props = ["title", "color", "typo", "typoColor", "typoSize", "clip"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("typo" in $$props) $$invalidate(2, typo = $$props.typo);
    		if ("typoColor" in $$props) $$invalidate(3, typoColor = $$props.typoColor);
    		if ("typoSize" in $$props) $$invalidate(4, typoSize = $$props.typoSize);
    	...
    	return [title, color, typo, typoColor, typoSize, showModal, clip];
    }
    ...
    class Podcast extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*title*/ ctx[0] === undefined && !("title" in props)) {
    			console.warn("<Podcast> was created without expected prop 'title'");
    		}

    		if (/*color*/ ctx[1] === undefined && !("color" in props)) {
    			console.warn("<Podcast> was created without expected prop 'color'");
    		}

    		if (/*typo*/ ctx[2] === undefined && !("typo" in props)) {
    			console.warn("<Podcast> was created without expected prop 'typo'");
    		}

    		if (/*typoColor*/ ctx[3] === undefined && !("typoColor" in props)) {
    			console.warn("<Podcast> was created without expected prop 'typoColor'");
    		}

    		if (/*typoSize*/ ctx[4] === undefined && !("typoSize" in props)) {
    			console.warn("<Podcast> was created without expected prop 'typoSize'");
    		}

    		if (/*clip*/ ctx[6] === undefined && !("clip" in props)) {
    			console.warn("<Podcast> was created without expected prop 'clip'");
    		}
    	}

    	get title() {
    		throw new Error("<Podcast>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set title(value) {
    		throw new Error("<Podcast>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 338, 12, 8116);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	podcast0 = new Podcast({
    			props: {
    				color: "#E423F0",
    				title: "On m’appelait le fils du diable",
    				typo: "Patua One",
    				typoColor: "#FFCF2A",
    				typoSize: "5em",
    				clip: "./audio/podcast1.mp3"
    			},
    			$$inline: true
    		});
    	...
    	podcast1 = new Podcast({
    			props: {
    				color: "#785BCA",
    				title: "On me comparait à un porcidou",
    				typo: "Recursive",
    				typoColor: "#55EFDB",
    				typoSize: "5em",
    				clip: "./audio/podcast2.mp3"
    			},
    			$$inline: true
    		});
    	...
    	podcast2 = new Podcast({
    			props: {
    				color: "#5FC9FA",
    				title: "On m'a ruiné ma scolarité",
    				typo: "Abril Fatface",
    				typoColor: "#FFFFFE",
    				typoSize: "5em",
    				clip: "./audio/podcast3.mp3"
    			},
    			$$inline: true
    		});
    	...
    	podcast3 = new Podcast({
    			props: {
    				color: "#E9CECE",
    				title: "J'étais trop maigre à leur yeux",
    				typo: "Days One",
    				typoColor: "#C92525",
    				typoSize: "5em",
    				clip: "./audio/podcast4.mp3"
    			},
    			$$inline: true
    		});
    	...
    	podcast4 = new Podcast({
    			props: {
    				color: "#F4A6D0",
    				title: "Je me suis vengé",
    				typo: "Goblin One",
    				typoColor: "#0060FF",
    				typoSize: "5em",
    				clip: "./audio/podcast5.mp3"
    			},
    			$$inline: true
    		});
    	...
    	podcast5 = new Podcast({
    			props: {
    				...
    				typoColor: "#FF9000",
    				typoSize: "5em",
    				clip: "./audio/podcast.mp3"
    			},
    			$$inline: true
    		});

    	podcast6 = new Podcast({
    			props: {
    				color: "#C0AAFF",
    				title: "Mes amis d'enfances m'ont harcelé",
    				typo: "Orbitron",
    				typoColor: "#90F2A0",
    				typoSize: "5em",
    				clip: "./audio/podcast7.mp3"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			create_component(podcast0.$$.fragment);
    			t0 = space();
    			create_component(podcast1.$$.fragment);
    			t1 = space();
    			create_component(podcast2.$$.fragment);
    			t2 = space();
    			create_component(podcast3.$$.fragment);
    			t3 = space();
    			create_component(podcast4.$$.fragment);
    			t4 = space();
    			create_component(podcast5.$$.fragment);
    			t5 = space();
    			create_component(podcast6.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(podcast0, target, anchor);
    			insert_dev(target, t0, anchor);
    			mount_component(podcast1, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(podcast2, target, anchor);
    			insert_dev(target, t2, anchor);
    			mount_component(podcast3, target, anchor);
    			insert_dev(target, t3, anchor);
    			mount_component(podcast4, target, anchor);
    			insert_dev(target, t4, anchor);
    			mount_component(podcast5, target, anchor);
    			insert_dev(target, t5, anchor);
    			mount_component(podcast6, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(podcast0.$$.fragment, local);
    			transition_in(podcast1.$$.fragment, local);
    			transition_in(podcast2.$$.fragment, local);
    			transition_in(podcast3.$$.fragment, local);
    			transition_in(podcast4.$$.fragment, local);
    			transition_in(podcast5.$$.fragment, local);
    			transition_in(podcast6.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(podcast0.$$.fragment, local);
    			transition_out(podcast1.$$.fragment, local);
    			transition_out(podcast2.$$.fragment, local);
    			transition_out(podcast3.$$.fragment, local);
    			transition_out(podcast4.$$.fragment, local);
    			transition_out(podcast5.$$.fragment, local);
    			transition_out(podcast6.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(podcast0, detaching);
    			if (detaching) detach_dev(t0);
    			destroy_component(podcast1, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(podcast2, detaching);
    			if (detaching) detach_dev(t2);
    			destroy_component(podcast3, detaching);
    			if (detaching) detach_dev(t3);
    			destroy_component(podcast4, detaching);
    			if (detaching) detach_dev(t4);
    			destroy_component(podcast5, detaching);
    			if (detaching) detach_dev(t5);
    			destroy_component(podcast6, detaching);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 8, 0, 132);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Podcast, Modal });
    	return [];
    }
